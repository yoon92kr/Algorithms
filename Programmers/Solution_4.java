...
public class Solution_4 {
	...
	public int[] solution(String[] id_list, String[] report, int k) {
		...
		ArrayList<String> black_list = check_black_list(set_black_list(update_report, update_report.size()), k);
	...
	private static ArrayList<String> check_black_list(HashMap<String, Integer> report, int max) {
		ArrayList<String> result = new ArrayList<String>();
	...
	// 블랙유저를 신고한 유저 리스트 확인
	private static ArrayList<String> set_report(ArrayList<String> report, ArrayList<String> black_list, int len) {
		ArrayList<String> result = new ArrayList<String>();
	...
	public static void main(String[] args) {
		Solution_4 test = new Solution_4();
